...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            // \App\Http\Middleware\TrackUserActivity::class, // Temporariamente comentado para teste
        ],
    ...
    protected $middlewareAliases = [
        ...
        'private.files' => \App\Http\Middleware\ServePrivateFiles::class,
        'permission' => \App\Http\Middleware\CheckPermission::class,
        'no_store' => \App\Http\Middleware\NoStoreForAuthenticated::class,
