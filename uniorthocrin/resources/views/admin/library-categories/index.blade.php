...
@section('title', 'Categorias de Biblioteca - Admin')
...
<div class="space-modern">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Categorias de Biblioteca</h1>
            <p class="text-gray-600 mt-2">Gerencie as categorias da biblioteca</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">{{ $category->library_count ?? 0 }} arquivos</p>
                                </div>
                            </div>
        ...
        <div class="modern-card">
            <div class="p-6">
                ...
                <form action="{{ route('admin.library-categories.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               placeholder="Ex: Manuais, Protocolos, Documentos..."
                               required>
                        @error('name')
...
function deleteCategory(categoryId) {
    if (confirm('Tem certeza que deseja excluir esta categoria? Esta ação não pode ser desfeita.')) {
        fetch(`/admin/library-categories/${categoryId}`, {
            method: 'DELETE',
            headers: {
