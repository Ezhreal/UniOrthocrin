...
<div class="space-modern">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-modern-title">Novo Produto</h1>
            <p class="text-modern-subtitle">Criar um novo produto na plataforma</p>
        </div>
    ...
    <!-- Modern Form -->
    <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" class="space-modern">
        @csrf
                    ...
                    <div>
                        ...
                        <select id="product_series_id" name="product_series_id"
                            ...
                            @foreach($series as $serie)
                                <option value="{{ $serie->id }}" {{ old('product_series_id') == $serie->id ? 'selected' : '' }}>
            ...
            <div class="modern-card-header">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="modern-card-subtitle">Configure quem pode visualizar e baixar este produto</p>
                    </div>
                </div>
            </div>
            <div class="space-modern-sm">
                ...
                <div class="modern-card hover-modern-lift">
                    ...
                    <div class="space-modern-sm">
                        ...
                        <div class="space-y-3">
                            ...
                            <a href="{{ route('admin.products.index') }}" class="btn-modern-secondary w-full text-center">
        ...
        <div class="flex justify-end space-x-3">
            ...
            <x-loading-button id="tour-submit-btn" type="submit" variant="primary" size="md" loading-text="Salvando Produto...">
