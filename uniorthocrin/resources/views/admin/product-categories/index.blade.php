...
@section('title', 'Categorias de Produtos - Admin')
...
<div class="space-modern">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Categorias de Produtos</h1>
            <p class="text-gray-600 mt-2">Gerencie as categorias dos produtos</p>
        </div>
    </div>
                ...
                <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">{{ $category->products_count ?? 0 }} produtos</p>
                                </div>
                            </div>
                    ...
                    @empty
                        <div class="text-center py-8">
                            <i class="fas fa-tag text-gray-300 text-4xl mb-4"></i>
