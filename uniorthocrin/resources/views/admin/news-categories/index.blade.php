...
@section('title', 'Categorias de Notícias - Admin')
...
<div class="space-modern">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Categorias de Notícias</h1>
            <p class="text-gray-600 mt-2">Gerencie as categorias das notícias</p>
        </div>
    </div>
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">{{ $category->news_count ?? 0 }} notícias</p>
                                </div>
                            </div>
                ...
                <form action="{{ route('admin.news-categories.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               placeholder="Ex: Tecnologia, Eventos, Novidades..."
                               required>
                        @error('name')
...
function deleteCategory(categoryId) {
    if (confirm('Tem certeza que deseja excluir esta categoria? Esta ação não pode ser desfeita.')) {
        fetch(`/admin/news-categories/${categoryId}`, {
            method: 'DELETE',
            headers: {
